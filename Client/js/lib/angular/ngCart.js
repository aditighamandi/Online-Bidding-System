...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', '$window', 'ngCartItem', 'store', function ($rootScope, $window, ngCartItem, store) {
        ...
        this.addItem = function (id, name, price, quantity, maxquantity, data) {
            ...
            if (typeof inCart === 'object') {
                ...
                var newItem = new ngCartItem(id, name, price, quantity, maxquantity, data);
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        item.prototype.setPrice = function (price) {
            ...
            if (priceFloat>=0) {
                if (priceFloat < 0) {
                    $log.error('A price must be greater than 0');
                } else {
        ...
        item.prototype.setQuantity = function (quantity, relative) {
            ...
            if (quantityInt % 1 === 0) {
                ...
                if (this._quantity > this._maxquantity) this._quantity = this._maxquantity;
                if (this._quantity < 1) this._quantity = 1;
                if(initData !== this._quantity) $rootScope.$broadcast('ngCart:change', {});
            } else {
                this._quantity = 1;
        ...
        item.prototype.setMaxQuantity = function (maxquantity, relative) {

            var quantityInt = parseInt(maxquantity);
            if (quantityInt % 1 === 0) {
                if (relative === true) {
                    this._maxquantity += quantityInt;
                } else {
                    this._maxquantity = quantityInt;
                }
                if (this._maxquantity < 1) this._maxquantity = 1;
